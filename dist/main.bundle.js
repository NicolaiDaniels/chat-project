...
var AppComponent = (function () {
    ...
    AppComponent.prototype.addPerson = function ($event) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_registration_registration_routing_module__ = __webpack_require__("../../../../../src/app/components/registration/registration-routing.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_registration_service__ = __webpack_require__("../../../../../src/app/services/registration.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__components_registration_registration_routing_module__["a" /* RegistrationRoutingModule */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_9__services_registration_service__["a" /* RegistrationService */]],
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.redirect = function () {
        console.log('hello i am nicolai');
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__registration_component__ = __webpack_require__("../../../../../src/app/components/registration/registration.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var registrationRoutes = [
    { path: 'registration-page', component: __WEBPACK_IMPORTED_MODULE_3__registration_component__["a" /* RegistrationComponent */] },
...
var RegistrationRoutingModule = (function () {
    ...
    RegistrationRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* RouterModule */].forChild(registrationRoutes)
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* RouterModule */]
            ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_registration_service__ = __webpack_require__("../../../../../src/app/services/registration.service.ts");
...
var RegistrationComponent = (function () {
    function RegistrationComponent(route, router, registrationService) {
        var _this = this;
        this.route = route;
        this.router = router;
    ...
    RegistrationComponent.prototype.addUser = function (event) {
        var _this = this;
        ...
        this.extractNames(this.name);
        if (!this.usernamesCheck.includes(this.name)) {
            ...
            alert('Username already in use. Pick a new one!');
        }
        console.log(this.name);
    };
    RegistrationComponent.prototype.extractNames = function (nme) {
        for (var _i = 0, _a = this.users; _i < _a.length; _i++) {
            var i = _a[_i];
            var a = i['name'];
            console.log(a);
            this.usernamesCheck.push(a);
        }
    };
    RegistrationComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__services_registration_service__["a" /* RegistrationService */]])
